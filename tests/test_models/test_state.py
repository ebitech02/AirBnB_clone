#!/usr/bin/python3
""" Define Module for State unittest """
...
class TestState_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        ...
        self.assertIn("[State] (234567)", state_str)
        self.assertIn("'id': '234567'", state_str)
...
class TestState_to_dict(unittest.TestCase):
    ...
    def test_to_dict_contains_added_attributes(self):
        state = State()
        state.middle_name = "Tucky"
        state.my_number = 333
        self.assertEqual("Tucky", state.middle_name)
